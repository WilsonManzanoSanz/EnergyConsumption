...
public class MetaMensualFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setView(inflator)
                ...
                .setPositiveButton("Añadir", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if ((!Objects.equals(editKwhPrice.getText().toString(), ""))) {
                            ((GraphActivity) getActivity()).saveMetaMensual(Integer.parseInt(editKwhPrice.getText().toString()));
                        }
                ...
                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        MetaMensualFragment.this.getDialog().cancel();
                        MetaMensualFragment.this.getDialog().dismiss();
